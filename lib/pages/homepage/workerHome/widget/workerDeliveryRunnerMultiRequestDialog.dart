...
class WorkerDeliveryRunnerMultiRequestDialog extends StatefulWidget {
  ...
  @override
  State<WorkerDeliveryRunnerMultiRequestDialog> createState() =>
      _WorkerDeliveryRunnerMultiRequestDialogState();
}

class _WorkerDeliveryRunnerMultiRequestDialogState
    extends State<WorkerDeliveryRunnerMultiRequestDialog> {
  int remainTime = 0;
  Timer? _timer;
