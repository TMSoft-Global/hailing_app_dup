...
class WorkerDeliveryRunnerSingleRequestDialog extends StatefulWidget {
  ...
  @override
  State<WorkerDeliveryRunnerSingleRequestDialog> createState() =>
      _WorkerDeliveryRunnerSingleRequestDialogState();
}

class _WorkerDeliveryRunnerSingleRequestDialogState
    extends State<WorkerDeliveryRunnerSingleRequestDialog> {
  int remainTime = 0;
  Timer? _timer;
