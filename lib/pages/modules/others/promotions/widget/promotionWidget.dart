      ...
      children: [
        ...
        for (int x = 0; x < 2; ++x)
          _layout(
            title: "FunRider",
            subtitle:
                "Get 20 rides or more today and get 20% discount on your sales",
            isToday: true,
            currentNumber: 3,
            totalNumber: 20,
          ),
        ...
        for (int x = 0; x < 5; ++x)
          _layout(
            title: "Findme Rider",
            subtitle:
                "Get 5 search request at a particular location and gain 100% discount on your sales",
            currentNumber: 1,
            totalNumber: 5,
          ),
        const SizedBox(height: 20),
...
Widget _layout({
  ...
  return Container(
    ...
    color: isToday
        ? BColors.primaryColor.withOpacity(.04)
        : BColors.primaryColor1.withOpacity(.04),
    child: ListTile(
