      ...
      child: Column(
        ...
        children: [
          ...
          RichText(
            text: TextSpan(
              text:
                  "Choose from the services below  what you’ll be rendering. ",
              style: Styles.h5Black,
              children: [
                TextSpan(
                  text:
                      "Note: You can select more than one, but your first choice will be your main Job.",
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Icon(
                            ...
                            color:
                                isCheck ? BColors.primaryColor : BColors.black,
                            size: 35,
                          ),
                        ],
                      ),
