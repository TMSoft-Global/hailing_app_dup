...
Widget rideMultiStopPlacesWidget({
  ...
  required void Function(int index) onMapPickerStop,
  required void Function(Size size) onTopWidgetSize,
  required void Function(String text, RidePlaceFields type, int? index)
      onPlaceTyping,
                ...
                ListTile(
                  ...
                  title: Container(
                    ...
                    child: textFormField(
                      ...
                      inputPadding: EdgeInsets.zero,
                      icon:
                          !(multiPlaceList[x]["focus"] as FocusNode).hasFocus &&
                                  multiPlaceList[x]["showClose"]
                              ? Icons.delete
                              : null,
