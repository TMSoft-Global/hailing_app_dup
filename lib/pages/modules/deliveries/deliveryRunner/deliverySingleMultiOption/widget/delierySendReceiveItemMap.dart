            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  subtitle: Text(
                    deliveryAddresses[DeliveryAccessLocation.pickUpLocation]
                                ["name"] ==
                            ""
                        ? "My current location"
                        : deliveryAddresses[
                ...
                ListTile(
                  ...
                  subtitle: Text(
                    deliveryAddresses[DeliveryAccessLocation.whereToLocation] ==
                        ...
                        ? "Enter location"
                        : deliveryAddresses[
                            DeliveryAccessLocation.whereToLocation]["name"],
                    style: Styles.h4BlackBold,
                  ),
                  trailing:
                      rideNextAction == RideMapNextAction.deliveryReceiveItem
                          ? button(
                              onPressed: () => onChangeLocation(
                                DeliveryAccessLocation.whereToLocation,
                              ),
