...
class _OtpVerificationState extends State<OtpVerification> {
  ...
  void _onOtpCodeReceived({String? code}) {
    ...
    if (match) {
      ...
      } else if (widget.authNextAction ==
              AuthNextAction.loginPhoneVerifyUserExit ||
    ...
    if (_formKey.currentState!.validate()) {
      ...
      Map<String, dynamic> httpResult = await httpChecker(
        httpRequesting: () => httpRequesting(
          ...
          httpPostBody: {
            "action":
                widget.authNextAction == AuthNextAction.forgotPasswordVerify
      ...
      if (httpResult["ok"]) {
        ...
        if (widget.authNextAction == AuthNextAction.loginEmailVerify) {
          ...
          Navigator.of(context).pushAndRemoveUntil(
            ...
            AuthNextAction.forgotPasswordVerify) {
          if (!mounted) return;
          Navigator.push(
            context,
            MaterialPageRoute(
        ...
        httpResult["statusCode"] == 200
            ...
            : toastContainer(
                text: httpResult["error"], backgroundColor: BColors.red);
      }
    }
  }
